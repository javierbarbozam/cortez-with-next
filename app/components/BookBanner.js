      ...
      <Container>
        ...
        >
          <Box position="relative" zIndex="1" w={{ base: "100%", md: "60%" }}>
            ...
            <Text>
              Unimos la lectura tradicional con la innovación tecnológica de la
              realidad aumentada para hacer que el aprendizaje temprano sea
              emocionante. Acompañanos en este viaje único.
            </Text>
            <Heading
